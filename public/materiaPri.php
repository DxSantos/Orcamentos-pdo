...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($existe > 0) {
    $erro = "⚠️ Já existe uma matéria-prima cadastrada com este nome!";
  } else {
    if (!empty($_POST['id'])) {
...
<body>
        ...
        <form method="post" class="card shadow-sm border-0">
          <div class="card-body">
            ...
            <div id="compradoFields">
              <h5 class="mb-3">Preço & Tributação</h5>
              <div class="row g-2 mb-3">
                <div class="col-md-6">
            ...
            <div id="fabricacaoFields">
              <h5 class="mb-3">Preço Fabricação</h5>
              <div class="mb-3">
            ...
            <div class="row g-2 mb-3">
              ...
              <div class="col-md-6">
                <label class="form-label fw-bold">Limite Alerta</label>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      const preco = document.querySelector('[name="preco_unitario"]');
      const icms = document.querySelector('[name="icms"]');
      if (preco && icms) {
        preco.addEventListener('input', calcularPrecoFinal);
        icms.addEventListener('input', calcularPrecoFinal);
      }
      toggleOrigem();
      calcularPrecoFinal();
    });
